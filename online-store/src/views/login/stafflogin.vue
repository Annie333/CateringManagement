  ...
  <div>
    <div class="c-box bg-box" >
     ...
     <!--        <div class="error btns login-form-tips" id="jsLoginTips" v-show="error"><p>用户名或密码错误</p></div> -->
            ...
            <input class="btn btn-green" id="jsLoginBtn" type="button" @click = "stafflogin" value="立即登录 &gt; ">
          </form>
          ...
          <p class="form-p">
            ...
            <router-link :to="'/app/login/'">[用户登陆]</router-link>
          </p>
        </div>
          ...
          password:this.passWord
              ...
              .catch(function (error) {
                ...
                if("password" in error){
                  that.passWordError = error.password[0];
                }
              });
      },
      errorUnshow(){
