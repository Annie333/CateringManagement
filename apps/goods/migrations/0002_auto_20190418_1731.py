...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='goods',
            name='goods_brief',
            field=models.TextField(default='', max_length=500, verbose_name='菜品简短描述'),
        ),
        migrations.AddField(
            model_name='goods',
            name='goods_desc',
        ...
        migrations.AddField(
            model_name='goods',
            name='sold_num',
            field=models.IntegerField(default=0, verbose_name='菜品销售量'),
        ),
        migrations.AddField(
            model_name='goods',
            name='window',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='goods.Windows', verbose_name='所在窗口'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='windows',
            name='parent_menu',
            field=models.ForeignKey(blank=True, help_text='菜单所在窗口', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='菜单所在窗口', to='goods.Windows', verbose_name='菜单所在窗口'),
        ),
        migrations.AddField(
            model_name='windows',
            name='parent_staff',
            field=models.ForeignKey(blank=True, help_text='员工所在窗口', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='员工所在窗口', to='goods.Windows', verbose_name='员工所在窗口'),
        ),
        migrations.CreateModel(
            name='IndexAd',
            fields=[
