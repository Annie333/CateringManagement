...
class ShoppingCartAdmin(object):
    list_display = ["user", "goods", "goods_num", "add_time", "windows"]
    search_fields = ["user__name", "goods__name", "goods_num", "sindows__id"]
    list_filter = ["user__name", "goods__name", "goods_num", "add_time", "sindows__id"]
...
class OrderInfoAdmin(object):
    ...
    search_fields = ["user__name", "order_sn", "trade_no", "pay_status", "order_mount","post_script",
                     "get_way", "address", "signer_name", "signer_identity", "signer_mobile", "windows__id"]
    list_filter = ["user__name", "add_time", "order_sn", "trade_no", "pay_status", "order_mount", "post_script",
                   "pay_time",
                   "get_way", "get_time", "address", "signer_name", "signer_identity", "signer_mobile", "windows__id"]
